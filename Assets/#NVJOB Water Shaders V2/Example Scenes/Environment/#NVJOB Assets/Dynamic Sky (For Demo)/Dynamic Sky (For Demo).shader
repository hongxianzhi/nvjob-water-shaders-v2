...
Shader "#NVJOB/Dynamic Sky URP" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma alpha:fade exclude_path:prepass nofog nolightmap nometa nolppv noshadowmask noshadow noforwardadd novertexlights halfasview
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                float4 _Level0Color, _Level1Color;
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                float4 pixelWorldSpacePosition = input.worldPos.y;
...
#endif
                return half4(albedoEnd.rgb, alphaEnd);
            }
            ENDHLSL
        }
    }
